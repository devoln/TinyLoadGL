...
#ifdef _WIN32
GlFunc<intptr_t()>* TINY_LOAD_GL_CALL wglGetProcAddress(const char* name);
#else
...
// TODO: common OpenGL ES extensions and some useful OpenGL core features (texture view, multi draw, etc.)
...
inline void loadDynamic(GlFunc<void()>* functions[], size_t numFunctions, const char* nullSeparatedNames, GlFunc<void()>*(*getProcAddress)(const char* name))
{
	char glName[100];
	glName[0] = 'g';
	glName[1] = 'l';
